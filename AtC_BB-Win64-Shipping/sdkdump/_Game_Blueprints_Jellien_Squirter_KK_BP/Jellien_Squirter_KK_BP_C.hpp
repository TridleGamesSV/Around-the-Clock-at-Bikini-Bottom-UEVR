...
namespace _Game_Blueprints_Jellien_Squirter_KK_BP {
#pragma pack(push, 1)
struct Jellien_Squirter_KK_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_87B08146426055EFE46A808A91E81D53();
    void* get_Timeline_1__Direction_87B08146426055EFE46A808A91E81D53();
    ...
    void ExecuteUbergraph_Jellien_Squirter_KK_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
