...
namespace _Game_Menus_Surveillance_5_Movement {
#pragma pack(push, 1)
struct Surveillance_5_Movement_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Surveillance_5_Movement(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
