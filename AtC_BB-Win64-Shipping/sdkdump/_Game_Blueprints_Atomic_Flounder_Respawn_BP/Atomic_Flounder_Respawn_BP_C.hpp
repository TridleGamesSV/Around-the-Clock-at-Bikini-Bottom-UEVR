...
namespace _Game_Blueprints_Atomic_Flounder_Respawn_BP {
#pragma pack(push, 1)
struct Atomic_Flounder_Respawn_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Atomic_Flounder_Respawn_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
