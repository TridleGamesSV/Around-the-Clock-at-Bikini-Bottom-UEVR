...
namespace _Game_Blueprints_Atomic_Flounder_3_BP {
#pragma pack(push, 1)
struct Atomic_Flounder_3_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Atomic_Flounder_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
