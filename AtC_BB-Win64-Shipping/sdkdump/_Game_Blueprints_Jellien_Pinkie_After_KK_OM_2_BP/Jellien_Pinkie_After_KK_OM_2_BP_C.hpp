...
namespace _Game_Blueprints_Jellien_Pinkie_After_KK_OM_2_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_After_KK_OM_2_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_067BB26848072451223BC2A0AE72DBE6();
    void* get_Timeline_0__Direction_067BB26848072451223BC2A0AE72DBE6();
    _Script_Engine::TimelineComponent*& get_Timeline_0();
    float& get_Timeline_1_Walk_19A3568E4960EDBA607DFCB2EEE3F392();
    void* get_Timeline_1__Direction_19A3568E4960EDBA607DFCB2EEE3F392();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_After_KK_OM_2_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
