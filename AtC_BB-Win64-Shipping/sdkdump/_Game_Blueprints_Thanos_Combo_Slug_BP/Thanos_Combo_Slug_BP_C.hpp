...
namespace _Game_Blueprints_Thanos_Combo_Slug_BP {
#pragma pack(push, 1)
struct Thanos_Combo_Slug_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Thanos_Combo_Slug_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
