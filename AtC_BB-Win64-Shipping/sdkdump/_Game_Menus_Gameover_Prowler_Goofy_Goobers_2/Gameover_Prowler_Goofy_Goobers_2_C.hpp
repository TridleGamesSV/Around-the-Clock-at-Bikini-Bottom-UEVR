...
namespace _Game_Menus_Gameover_Prowler_Goofy_Goobers_2 {
#pragma pack(push, 1)
struct Gameover_Prowler_Goofy_Goobers_2_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Prowler_Goofy_Goobers_2(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
