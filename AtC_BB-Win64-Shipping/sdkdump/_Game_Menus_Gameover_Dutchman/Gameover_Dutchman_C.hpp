...
namespace _Game_Menus_Gameover_Dutchman {
#pragma pack(push, 1)
struct Gameover_Dutchman_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Dutchman(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
