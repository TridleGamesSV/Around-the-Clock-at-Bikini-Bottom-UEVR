...
namespace _Game_Blueprints_Berry_the_Bear_Doll_BP {
#pragma pack(push, 1)
struct Berry_the_Bear_Doll_BP_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_Berry_the_Bear_Doll_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
