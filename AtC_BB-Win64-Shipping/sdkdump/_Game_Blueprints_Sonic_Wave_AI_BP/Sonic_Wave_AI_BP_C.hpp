...
namespace _Game_Blueprints_Sonic_Wave_AI_BP {
#pragma pack(push, 1)
struct Sonic_Wave_AI_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_631B4D534E8F454A7DF6A18722B49D91(void* MovementResult);
    void OnSuccess_631B4D534E8F454A7DF6A18722B49D91(void* MovementResult);
    ...
    void ExecuteUbergraph_Sonic_Wave_AI_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
