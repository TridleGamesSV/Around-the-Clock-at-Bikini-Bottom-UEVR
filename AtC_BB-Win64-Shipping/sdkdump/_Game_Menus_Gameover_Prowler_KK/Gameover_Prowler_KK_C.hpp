...
namespace _Game_Menus_Gameover_Prowler_KK {
#pragma pack(push, 1)
struct Gameover_Prowler_KK_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Prowler_KK(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
