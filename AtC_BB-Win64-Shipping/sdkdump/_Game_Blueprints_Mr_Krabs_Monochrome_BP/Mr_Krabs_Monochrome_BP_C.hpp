...
namespace _Game_Blueprints_Mr_Krabs_Monochrome_BP {
#pragma pack(push, 1)
struct Mr_Krabs_Monochrome_BP_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_Mr_Krabs_Monochrome_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
