...
namespace _Game_Blueprints_Volter_Goofy_BP {
#pragma pack(push, 1)
struct Volter_Goofy_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_BF3FE77A43320B33EC718199EFB8341A();
    void* get_Timeline_0__Direction_BF3FE77A43320B33EC718199EFB8341A();
    ...
    void ExecuteUbergraph_Volter_Goofy_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
