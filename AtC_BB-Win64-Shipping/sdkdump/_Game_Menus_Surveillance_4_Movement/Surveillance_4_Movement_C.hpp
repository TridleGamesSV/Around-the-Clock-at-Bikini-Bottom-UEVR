...
namespace _Game_Menus_Surveillance_4_Movement {
#pragma pack(push, 1)
struct Surveillance_4_Movement_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Surveillance_4_Movement(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
