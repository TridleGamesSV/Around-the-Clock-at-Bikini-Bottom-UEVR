...
namespace _Game_Blueprints_Climb_Up_Cellar_BP {
#pragma pack(push, 1)
struct Climb_Up_Cellar_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Climb_Up_Cellar_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
