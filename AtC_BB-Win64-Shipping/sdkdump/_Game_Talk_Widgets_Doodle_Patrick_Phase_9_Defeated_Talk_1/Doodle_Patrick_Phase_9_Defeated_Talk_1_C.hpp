...
namespace _Game_Talk_Widgets_Doodle_Patrick_Phase_9_Defeated_Talk_1 {
#pragma pack(push, 1)
struct Doodle_Patrick_Phase_9_Defeated_Talk_1_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Doodle_Patrick_Phase_9_Defeated_Talk_1(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
