...
namespace _Game_Blueprints_Patrick_Surveillance_Intro_Walk_3_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Intro_Walk_3_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_1DD075B444B1FB01C14E2198406068EB(void* MovementResult);
    void OnSuccess_1DD075B444B1FB01C14E2198406068EB(void* MovementResult);
    void ReceiveBeginPlay();
    void ExecuteUbergraph_Patrick_Surveillance_Intro_Walk_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
