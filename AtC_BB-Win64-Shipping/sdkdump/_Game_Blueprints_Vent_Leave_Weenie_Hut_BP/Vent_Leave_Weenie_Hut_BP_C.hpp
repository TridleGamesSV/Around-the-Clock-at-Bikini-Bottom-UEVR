...
namespace _Game_Blueprints_Vent_Leave_Weenie_Hut_BP {
#pragma pack(push, 1)
struct Vent_Leave_Weenie_Hut_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Vent_Leave_Weenie_Hut_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
