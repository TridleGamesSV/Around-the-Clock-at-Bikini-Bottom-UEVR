...
namespace _Game_Blueprints_Dirty_Bubble_3_BP {
#pragma pack(push, 1)
struct Dirty_Bubble_3_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Dirty_Bubble_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
