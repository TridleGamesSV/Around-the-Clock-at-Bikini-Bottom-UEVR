...
namespace _Game_Talk_Widgets_Squidward_Mid_Goo_Lagoon_10 {
#pragma pack(push, 1)
struct Squidward_Mid_Goo_Lagoon_10_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Squidward_Mid_Goo_Lagoon_10(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
