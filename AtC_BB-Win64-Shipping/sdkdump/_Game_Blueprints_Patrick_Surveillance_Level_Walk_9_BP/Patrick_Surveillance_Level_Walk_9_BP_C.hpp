...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_9_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_9_BP_C : public _Script_Engine::Character {
    void* get_UberGraphFrame();
    _Script_Engine::StaticMeshComponent*& get_Scared();
    ...
    void OnFail_A0587C4B4936ADE0624DC8815EDD5F7B(void* MovementResult);
    void OnSuccess_A0587C4B4936ADE0624DC8815EDD5F7B(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_9_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
