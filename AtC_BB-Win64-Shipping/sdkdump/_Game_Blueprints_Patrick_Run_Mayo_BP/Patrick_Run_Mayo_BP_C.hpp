...
namespace _Game_Blueprints_Patrick_Run_Mayo_BP {
#pragma pack(push, 1)
struct Patrick_Run_Mayo_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_A834E86C484C2031EA9E1CADA928FE4F(void* MovementResult);
    void OnSuccess_A834E86C484C2031EA9E1CADA928FE4F(void* MovementResult);
    void ReceiveBeginPlay();
    void ExecuteUbergraph_Patrick_Run_Mayo_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
