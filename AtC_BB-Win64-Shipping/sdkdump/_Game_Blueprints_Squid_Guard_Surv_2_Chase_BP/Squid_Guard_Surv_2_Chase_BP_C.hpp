...
namespace _Game_Blueprints_Squid_Guard_Surv_2_Chase_BP {
#pragma pack(push, 1)
struct Squid_Guard_Surv_2_Chase_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_5BA0F155443B737C7ED053B82847F836();
    void* get_Timeline_0__Direction_5BA0F155443B737C7ED053B82847F836();
    ...
    void ExecuteUbergraph_Squid_Guard_Surv_2_Chase_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
