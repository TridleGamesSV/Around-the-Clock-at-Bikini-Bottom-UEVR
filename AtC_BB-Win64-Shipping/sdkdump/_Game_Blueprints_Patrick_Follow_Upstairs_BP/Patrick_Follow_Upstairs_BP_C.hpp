...
namespace _Game_Blueprints_Patrick_Follow_Upstairs_BP {
#pragma pack(push, 1)
struct Patrick_Follow_Upstairs_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Patrick_Follow_Upstairs_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
