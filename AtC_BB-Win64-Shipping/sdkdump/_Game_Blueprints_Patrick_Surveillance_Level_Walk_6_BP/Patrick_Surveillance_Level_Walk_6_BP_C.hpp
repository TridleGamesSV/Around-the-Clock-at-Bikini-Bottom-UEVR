...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_6_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_6_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_E386367B4AD6DC8302251581C5C7E1BC(void* MovementResult);
    void OnSuccess_E386367B4AD6DC8302251581C5C7E1BC(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_6_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
