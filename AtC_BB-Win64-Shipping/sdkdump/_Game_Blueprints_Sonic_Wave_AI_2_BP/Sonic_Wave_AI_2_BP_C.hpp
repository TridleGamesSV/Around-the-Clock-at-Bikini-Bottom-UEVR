...
namespace _Game_Blueprints_Sonic_Wave_AI_2_BP {
#pragma pack(push, 1)
struct Sonic_Wave_AI_2_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_E623F4D14F20DF533C6C51B0A6DF4E18(void* MovementResult);
    void OnSuccess_E623F4D14F20DF533C6C51B0A6DF4E18(void* MovementResult);
    ...
    void ExecuteUbergraph_Sonic_Wave_AI_2_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
