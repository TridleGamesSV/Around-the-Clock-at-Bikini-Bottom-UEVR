...
namespace _Game_Blueprints_Prowler_Goofy_Suit_1300_BP {
#pragma pack(push, 1)
struct Prowler_Goofy_Suit_1300_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Prowler_Goofy_Suit_1300_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
