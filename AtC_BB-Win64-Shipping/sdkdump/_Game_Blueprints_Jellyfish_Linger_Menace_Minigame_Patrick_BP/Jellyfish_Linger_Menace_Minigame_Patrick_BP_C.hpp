...
namespace _Game_Blueprints_Jellyfish_Linger_Menace_Minigame_Patrick_BP {
#pragma pack(push, 1)
struct Jellyfish_Linger_Menace_Minigame_Patrick_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_DDEA70F5496373C8138FC0997A2A56F4();
    void* get_Timeline_1__Direction_DDEA70F5496373C8138FC0997A2A56F4();
    ...
    void ExecuteUbergraph_Jellyfish_Linger_Menace_Minigame_Patrick_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
