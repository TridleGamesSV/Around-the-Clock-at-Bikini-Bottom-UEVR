...
namespace _Game_Menus_Surveillance_3_Movement {
#pragma pack(push, 1)
struct Surveillance_3_Movement_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Surveillance_3_Movement(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
