...
namespace _Game_Blueprints_Bessy_Boss_Phase_2_End_BP {
#pragma pack(push, 1)
struct Bessy_Boss_Phase_2_End_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Bessy_Boss_Phase_2_End_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
