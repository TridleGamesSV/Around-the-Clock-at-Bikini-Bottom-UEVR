...
namespace _Game_Menus_Gameover_Prowler_Goofy_Goobers {
#pragma pack(push, 1)
struct Gameover_Prowler_Goofy_Goobers_C : public _Script_UMG::UserWidget {
    void* get_UberGraphFrame();
    _Script_UMG::WidgetAnimation*& get_Hint_4();
    _Script_UMG::WidgetAnimation*& get_Hint_3();
    _Script_UMG::WidgetAnimation*& get_You_Sure();
    _Script_UMG::WidgetAnimation*& get_Fade_Out();
    _Script_UMG::WidgetAnimation*& get_Hint_2();
    ...
    void ExecuteUbergraph_Gameover_Prowler_Goofy_Goobers(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
