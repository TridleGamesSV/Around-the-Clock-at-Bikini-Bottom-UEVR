...
namespace _Game_Blueprints_Pearl_Examine_BP {
#pragma pack(push, 1)
struct Pearl_Examine_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Pearl_Examine_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
