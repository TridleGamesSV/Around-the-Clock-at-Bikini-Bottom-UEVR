...
namespace _Game_Blueprints_Larry_The_Lobster_End_BP {
#pragma pack(push, 1)
struct Larry_The_Lobster_End_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Larry_The_Lobster_End_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
