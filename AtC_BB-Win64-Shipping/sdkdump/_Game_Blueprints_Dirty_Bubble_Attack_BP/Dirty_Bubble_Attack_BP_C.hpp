...
namespace _Game_Blueprints_Dirty_Bubble_Attack_BP {
#pragma pack(push, 1)
struct Dirty_Bubble_Attack_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Dirty_Bubble_Attack_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
