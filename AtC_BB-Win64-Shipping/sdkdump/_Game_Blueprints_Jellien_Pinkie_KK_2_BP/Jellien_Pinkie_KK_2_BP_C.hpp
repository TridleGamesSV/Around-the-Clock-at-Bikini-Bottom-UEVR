...
namespace _Game_Blueprints_Jellien_Pinkie_KK_2_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_KK_2_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_1D63D2BC487A9D67289C7284BF863B71();
    void* get_Timeline_1__Direction_1D63D2BC487A9D67289C7284BF863B71();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_KK_2_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
