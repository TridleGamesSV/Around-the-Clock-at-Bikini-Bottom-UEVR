...
namespace _Game_Menus_Gameover_Mermalair_Boss {
#pragma pack(push, 1)
struct Gameover_Mermalair_Boss_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Mermalair_Boss(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
