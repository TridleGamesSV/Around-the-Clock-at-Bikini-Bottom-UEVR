...
namespace _Game_Blueprints_Mayo_Minigun_PickUp_BP {
#pragma pack(push, 1)
struct Mayo_Minigun_PickUp_BP_C : public _Script_Engine::StaticMeshActor {
    void* get_UberGraphFrame();
    _Script_Engine::ParticleSystemComponent*& get_Interact();
    ...
    void ExecuteUbergraph_Mayo_Minigun_PickUp_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
