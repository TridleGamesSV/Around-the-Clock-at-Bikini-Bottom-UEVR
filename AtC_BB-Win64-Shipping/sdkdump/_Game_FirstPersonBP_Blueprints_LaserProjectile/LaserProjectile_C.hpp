...
namespace _Game_FirstPersonBP_Blueprints_LaserProjectile {
#pragma pack(push, 1)
struct LaserProjectile_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_LaserProjectile(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
