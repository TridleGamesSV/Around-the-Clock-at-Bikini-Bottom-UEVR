...
namespace _Game_Blueprints_Jellien_Pinkie_After_KK_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_After_KK_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_732C1A41405ADA92EB89138FB96A162F();
    void* get_Timeline_0__Direction_732C1A41405ADA92EB89138FB96A162F();
    _Script_Engine::TimelineComponent*& get_Timeline_0();
    float& get_Timeline_1_Walk_6D89C3D344A611B69AD8959C014C9D8F();
    void* get_Timeline_1__Direction_6D89C3D344A611B69AD8959C014C9D8F();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_After_KK_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
