...
namespace _Game_Talk_Widgets_MrKrabs_Mid_Goo_Lagoon_2 {
#pragma pack(push, 1)
struct MrKrabs_Mid_Goo_Lagoon_2_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_MrKrabs_Mid_Goo_Lagoon_2(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
