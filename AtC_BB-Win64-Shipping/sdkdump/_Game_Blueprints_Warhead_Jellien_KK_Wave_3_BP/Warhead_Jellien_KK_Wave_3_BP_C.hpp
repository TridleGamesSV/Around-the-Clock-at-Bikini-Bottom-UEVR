...
namespace _Game_Blueprints_Warhead_Jellien_KK_Wave_3_BP {
#pragma pack(push, 1)
struct Warhead_Jellien_KK_Wave_3_BP_C : public _Script_Engine::Character {
    ...
    _Script_Engine::AudioComponent*& get_Missle();
    ...
    void ExecuteUbergraph_Warhead_Jellien_KK_Wave_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
