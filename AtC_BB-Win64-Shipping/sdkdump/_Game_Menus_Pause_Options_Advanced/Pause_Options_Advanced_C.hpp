...
namespace _Game_Menus_Pause_Options_Advanced {
#pragma pack(push, 1)
struct Pause_Options_Advanced_C : public _Script_UMG::UserWidget {
    ...
    void BndEvt__Button_16_K2Node_ComponentBoundEvent_241_OnButtonPressedEvent__DelegateSignature();
    void BndEvt__Button_17_K2Node_ComponentBoundEvent_283_OnButtonPressedEvent__DelegateSignature();
    void ExecuteUbergraph_Pause_Options_Advanced(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
