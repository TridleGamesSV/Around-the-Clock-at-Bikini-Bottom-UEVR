...
namespace _Game_Menus_Gameover_Guard_Surv_1 {
#pragma pack(push, 1)
struct Gameover_Guard_Surv_1_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Guard_Surv_1(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
