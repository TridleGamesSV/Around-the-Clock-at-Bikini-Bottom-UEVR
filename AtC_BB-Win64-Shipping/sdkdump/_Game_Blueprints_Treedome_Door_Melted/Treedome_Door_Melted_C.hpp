...
namespace _Game_Blueprints_Treedome_Door_Melted {
#pragma pack(push, 1)
struct Treedome_Door_Melted_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_Treedome_Door_Melted(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
