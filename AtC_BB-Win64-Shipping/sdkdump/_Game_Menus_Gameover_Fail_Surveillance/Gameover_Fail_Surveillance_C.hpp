...
namespace _Game_Menus_Gameover_Fail_Surveillance {
#pragma pack(push, 1)
struct Gameover_Fail_Surveillance_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Fail_Surveillance(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
