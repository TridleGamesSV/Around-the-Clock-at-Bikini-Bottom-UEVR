...
namespace _Game_Talk_Widgets_Squidward_Jellyfishing_Minigame_Win_Talk_3 {
#pragma pack(push, 1)
struct Squidward_Jellyfishing_Minigame_Win_Talk_3_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Squidward_Jellyfishing_Minigame_Win_Talk_3(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
