...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_5_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_5_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_B5AA902D4632EDEC5CBAC9BD8B65B4A8(void* MovementResult);
    void OnSuccess_B5AA902D4632EDEC5CBAC9BD8B65B4A8(void* MovementResult);
    void OnFail_147AFB344A87AF2E196792BBE3B8E4B9(void* MovementResult);
    void OnSuccess_147AFB344A87AF2E196792BBE3B8E4B9(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_5_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
