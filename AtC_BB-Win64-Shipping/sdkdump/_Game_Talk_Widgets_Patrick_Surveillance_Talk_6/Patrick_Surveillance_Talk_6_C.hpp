...
namespace _Game_Talk_Widgets_Patrick_Surveillance_Talk_6 {
#pragma pack(push, 1)
struct Patrick_Surveillance_Talk_6_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Patrick_Surveillance_Talk_6(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
