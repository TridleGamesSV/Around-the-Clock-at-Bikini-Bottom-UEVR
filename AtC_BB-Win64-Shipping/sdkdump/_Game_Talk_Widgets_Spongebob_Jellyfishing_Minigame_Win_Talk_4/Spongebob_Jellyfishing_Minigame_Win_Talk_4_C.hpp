...
namespace _Game_Talk_Widgets_Spongebob_Jellyfishing_Minigame_Win_Talk_4 {
#pragma pack(push, 1)
struct Spongebob_Jellyfishing_Minigame_Win_Talk_4_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Spongebob_Jellyfishing_Minigame_Win_Talk_4(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
