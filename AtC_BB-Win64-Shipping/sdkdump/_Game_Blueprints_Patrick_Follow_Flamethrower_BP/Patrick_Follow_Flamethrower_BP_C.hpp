...
namespace _Game_Blueprints_Patrick_Follow_Flamethrower_BP {
#pragma pack(push, 1)
struct Patrick_Follow_Flamethrower_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Patrick_Follow_Flamethrower_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
