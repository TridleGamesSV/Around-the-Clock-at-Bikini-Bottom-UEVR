...
namespace _Game_Blueprints_Investigate_Objective_BP {
#pragma pack(push, 1)
struct Investigate_Objective_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Investigate_Objective_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
