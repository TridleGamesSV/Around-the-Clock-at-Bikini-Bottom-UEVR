...
namespace _Game_Menus_Gameover_Patrick_Death_KK {
#pragma pack(push, 1)
struct Gameover_Patrick_Death_KK_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Patrick_Death_KK(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
