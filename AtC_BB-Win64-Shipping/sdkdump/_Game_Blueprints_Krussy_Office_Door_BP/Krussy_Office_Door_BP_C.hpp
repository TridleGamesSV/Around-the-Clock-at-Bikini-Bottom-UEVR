...
namespace _Game_Blueprints_Krussy_Office_Door_BP {
#pragma pack(push, 1)
struct Krussy_Office_Door_BP_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_Krussy_Office_Door_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
