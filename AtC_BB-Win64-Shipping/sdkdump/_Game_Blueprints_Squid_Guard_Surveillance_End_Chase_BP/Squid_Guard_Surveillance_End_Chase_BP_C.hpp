...
namespace _Game_Blueprints_Squid_Guard_Surveillance_End_Chase_BP {
#pragma pack(push, 1)
struct Squid_Guard_Surveillance_End_Chase_BP_C : public _Script_Engine::Character {
    void* get_UberGraphFrame();
    _Script_Engine::AudioComponent*& get_Spotted_7();
    _Script_Engine::AudioComponent*& get_Spotted_6();
    _Script_Engine::AudioComponent*& get_Spotted_5();
    _Script_Engine::AudioComponent*& get_Spotted_4();
    _Script_Engine::AudioComponent*& get_Spotted_3();
    _Script_Engine::AudioComponent*& get_Spotted_2();
    _Script_Engine::AudioComponent*& get_Spotted_1();
    ...
    float& get_Timeline_0_Walk_609FD9434D706716571845B1C67C0079();
    void* get_Timeline_0__Direction_609FD9434D706716571845B1C67C0079();
    ...
    void ExecuteUbergraph_Squid_Guard_Surveillance_End_Chase_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
