...
namespace _Game_Menus_Pause_Gloveworld {
#pragma pack(push, 1)
struct Pause_Gloveworld_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Pause_Gloveworld(int32_t EntryPoint);
