...
namespace _Game_Blueprints_Dirty_Bubble_Wall_AI_BP {
#pragma pack(push, 1)
struct Dirty_Bubble_Wall_AI_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_D381B4FC4702DCB13521CE99DF788AF4(void* MovementResult);
    void OnSuccess_D381B4FC4702DCB13521CE99DF788AF4(void* MovementResult);
    ...
    void ExecuteUbergraph_Dirty_Bubble_Wall_AI_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
