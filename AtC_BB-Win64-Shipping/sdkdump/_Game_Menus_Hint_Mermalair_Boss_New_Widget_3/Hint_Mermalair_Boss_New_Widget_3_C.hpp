...
namespace _Game_Menus_Hint_Mermalair_Boss_New_Widget_3 {
#pragma pack(push, 1)
struct Hint_Mermalair_Boss_New_Widget_3_C : public _Script_UMG::UserWidget {
    void* get_UberGraphFrame();
    _Script_UMG::WidgetAnimation*& get_Fade();
    _Script_UMG::Button*& get_Button_0();
    _Script_UMG::Button*& get_Button_79();
    ...
    _Script_UMG::Image*& get_Image_269();
    ...
    void BndEvt__Button_79_K2Node_ComponentBoundEvent_30_OnButtonPressedEvent__DelegateSignature();
    void BndEvt__Button_0_K2Node_ComponentBoundEvent_47_OnButtonPressedEvent__DelegateSignature();
    void ExecuteUbergraph_Hint_Mermalair_Boss_New_Widget_3(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
