...
namespace _Game_Menus_Gameover_Iron_Dogfish_Surv {
#pragma pack(push, 1)
struct Gameover_Iron_Dogfish_Surv_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Iron_Dogfish_Surv(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
