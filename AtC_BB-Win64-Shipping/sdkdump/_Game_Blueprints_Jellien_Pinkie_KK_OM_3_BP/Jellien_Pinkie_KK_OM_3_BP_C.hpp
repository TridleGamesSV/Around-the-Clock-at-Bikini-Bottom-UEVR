...
namespace _Game_Blueprints_Jellien_Pinkie_KK_OM_3_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_KK_OM_3_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_FCBE7F31474012B04D923C995E9CAF97();
    void* get_Timeline_1__Direction_FCBE7F31474012B04D923C995E9CAF97();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_KK_OM_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
