...
namespace _Game_Menus_Gameover_Plankton_Laser {
#pragma pack(push, 1)
struct Gameover_Plankton_Laser_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Plankton_Laser(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
