...
namespace _Game_Blueprints_Hash_Pursue_Frontdoor_BP {
#pragma pack(push, 1)
struct Hash_Pursue_Frontdoor_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Hash_Pursue_Frontdoor_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
