...
namespace _Game_FirstPersonBP_Blueprints_RockProjectile {
#pragma pack(push, 1)
struct RockProjectile_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_RockProjectile(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
