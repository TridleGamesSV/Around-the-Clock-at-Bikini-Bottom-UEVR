...
namespace _Game_FirstPersonBP_Blueprints_FirstPersonProjectile {
#pragma pack(push, 1)
struct FirstPersonProjectile_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_FirstPersonProjectile(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
