...
namespace _Game_Blueprints_Jellion_Horned_Health_Patrick_BP {
#pragma pack(push, 1)
struct Jellion_Horned_Health_Patrick_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_2E8763AF4D9A3FF5B51E6BBAFA133A99();
    void* get_Timeline_1__Direction_2E8763AF4D9A3FF5B51E6BBAFA133A99();
    ...
    void ExecuteUbergraph_Jellion_Horned_Health_Patrick_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
