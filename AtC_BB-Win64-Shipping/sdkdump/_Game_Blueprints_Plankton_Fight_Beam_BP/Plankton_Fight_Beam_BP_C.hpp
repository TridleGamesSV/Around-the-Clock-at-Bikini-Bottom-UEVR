...
namespace _Game_Blueprints_Plankton_Fight_Beam_BP {
#pragma pack(push, 1)
struct Plankton_Fight_Beam_BP_C : public _Script_Engine::Character {
    ...
    _Script_Engine::PointLightComponent*& get_Laser_Light();
    ...
    void ExecuteUbergraph_Plankton_Fight_Beam_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
