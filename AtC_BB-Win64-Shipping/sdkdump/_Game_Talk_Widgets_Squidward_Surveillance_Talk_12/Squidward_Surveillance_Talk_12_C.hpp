...
namespace _Game_Talk_Widgets_Squidward_Surveillance_Talk_12 {
#pragma pack(push, 1)
struct Squidward_Surveillance_Talk_12_C : public _Script_UMG::UserWidget {
    void* get_UberGraphFrame();
    _Script_UMG::WidgetAnimation*& get_Swear();
    ...
    void ExecuteUbergraph_Squidward_Surveillance_Talk_12(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
