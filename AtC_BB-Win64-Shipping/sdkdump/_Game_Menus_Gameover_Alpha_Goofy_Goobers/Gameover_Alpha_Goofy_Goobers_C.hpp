...
namespace _Game_Menus_Gameover_Alpha_Goofy_Goobers {
#pragma pack(push, 1)
struct Gameover_Alpha_Goofy_Goobers_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Alpha_Goofy_Goobers(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
