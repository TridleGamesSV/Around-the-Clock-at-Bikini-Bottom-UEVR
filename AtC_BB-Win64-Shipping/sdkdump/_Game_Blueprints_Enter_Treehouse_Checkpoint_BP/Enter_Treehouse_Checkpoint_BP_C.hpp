...
namespace _Game_Blueprints_Enter_Treehouse_Checkpoint_BP {
#pragma pack(push, 1)
struct Enter_Treehouse_Checkpoint_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Enter_Treehouse_Checkpoint_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
