...
namespace _Game_Blueprints_Sneaky_Nipper_Projectile_BP {
#pragma pack(push, 1)
struct Sneaky_Nipper_Projectile_BP_C : public _Script_Engine::Actor {
    void* get_UberGraphFrame();
    _Script_Engine::StaticMeshComponent*& get_Nipper();
    ...
    void ExecuteUbergraph_Sneaky_Nipper_Projectile_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
