...
namespace _Game_Blueprints_Electricity_Projectile_Tutorial_BP {
#pragma pack(push, 1)
struct Electricity_Projectile_Tutorial_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Electricity_Projectile_Tutorial_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
