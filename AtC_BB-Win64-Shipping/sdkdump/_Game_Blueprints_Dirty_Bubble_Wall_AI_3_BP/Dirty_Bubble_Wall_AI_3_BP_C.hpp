...
namespace _Game_Blueprints_Dirty_Bubble_Wall_AI_3_BP {
#pragma pack(push, 1)
struct Dirty_Bubble_Wall_AI_3_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_A1860FC64AF6CA5F6ECF42A244121D25(void* MovementResult);
    void OnSuccess_A1860FC64AF6CA5F6ECF42A244121D25(void* MovementResult);
    ...
    void ExecuteUbergraph_Dirty_Bubble_Wall_AI_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
