...
namespace _Game_Blueprints_Jellien_Pinkie_After_KK_OM_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_After_KK_OM_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_986FA5394465617E6645E9A259BF4F29();
    void* get_Timeline_0__Direction_986FA5394465617E6645E9A259BF4F29();
    _Script_Engine::TimelineComponent*& get_Timeline_0();
    float& get_Timeline_1_Walk_D074220C4C12CB12648A219A0AA6DA1C();
    void* get_Timeline_1__Direction_D074220C4C12CB12648A219A0AA6DA1C();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_After_KK_OM_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
