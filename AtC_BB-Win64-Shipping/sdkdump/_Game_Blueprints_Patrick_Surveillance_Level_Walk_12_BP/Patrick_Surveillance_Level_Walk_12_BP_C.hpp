...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_12_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_12_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_36709B1A48ABC1137B1534B7FEBACD6A(void* MovementResult);
    void OnSuccess_36709B1A48ABC1137B1534B7FEBACD6A(void* MovementResult);
    void OnFail_E08C5F2144BD7EBC391AD293B4C90200(void* MovementResult);
    void OnSuccess_E08C5F2144BD7EBC391AD293B4C90200(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_12_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
