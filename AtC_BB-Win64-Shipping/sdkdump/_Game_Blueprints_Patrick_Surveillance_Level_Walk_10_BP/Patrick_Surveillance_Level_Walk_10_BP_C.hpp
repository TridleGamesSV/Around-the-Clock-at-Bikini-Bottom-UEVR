...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_10_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_10_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_D37B3F4D460263A2C27106ABA32A41DF(void* MovementResult);
    void OnSuccess_D37B3F4D460263A2C27106ABA32A41DF(void* MovementResult);
    void OnFail_6FA6F9734B3997EA929B06AE1897E14B(void* MovementResult);
    void OnSuccess_6FA6F9734B3997EA929B06AE1897E14B(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_10_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
