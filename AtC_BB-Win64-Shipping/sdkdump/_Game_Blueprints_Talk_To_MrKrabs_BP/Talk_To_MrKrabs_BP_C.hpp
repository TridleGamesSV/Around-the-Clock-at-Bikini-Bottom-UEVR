...
namespace _Game_Blueprints_Talk_To_MrKrabs_BP {
#pragma pack(push, 1)
struct Talk_To_MrKrabs_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Talk_To_MrKrabs_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
