...
namespace _Game_Menus_Gameover_Mrs_Puff {
#pragma pack(push, 1)
struct Gameover_Mrs_Puff_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Mrs_Puff(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
