...
namespace _Game_Blueprints_Wood_House_Door_BP {
#pragma pack(push, 1)
struct Wood_House_Door_BP_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_Wood_House_Door_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
