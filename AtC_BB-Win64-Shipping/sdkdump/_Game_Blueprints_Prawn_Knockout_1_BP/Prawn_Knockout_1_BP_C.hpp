...
namespace _Game_Blueprints_Prawn_Knockout_1_BP {
#pragma pack(push, 1)
struct Prawn_Knockout_1_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Prawn_Knockout_1_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
