...
namespace _Game_Blueprints_Man_Ray_Counter_Attack_Thanos_BP {
#pragma pack(push, 1)
struct Man_Ray_Counter_Attack_Thanos_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Man_Ray_Counter_Attack_Thanos_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
