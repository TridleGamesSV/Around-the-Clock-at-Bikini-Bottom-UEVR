...
namespace _Game_Blueprints_Sandy_Chase_Checkpoint_BP {
#pragma pack(push, 1)
struct Sandy_Chase_Checkpoint_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_1FFC77234DF1AB61B6A970BB3E0442AF();
    void* get_Timeline_1__Direction_1FFC77234DF1AB61B6A970BB3E0442AF();
    ...
    void ExecuteUbergraph_Sandy_Chase_Checkpoint_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
