...
namespace _Game_Blueprints_Run_Activate_Sandy_BP {
#pragma pack(push, 1)
struct Run_Activate_Sandy_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Run_Activate_Sandy_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
