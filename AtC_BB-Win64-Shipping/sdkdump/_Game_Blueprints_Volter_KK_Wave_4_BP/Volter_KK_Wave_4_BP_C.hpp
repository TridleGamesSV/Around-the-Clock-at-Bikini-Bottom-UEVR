...
namespace _Game_Blueprints_Volter_KK_Wave_4_BP {
#pragma pack(push, 1)
struct Volter_KK_Wave_4_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_AF4CEC274DB8CAA5C1936EB248B873EF();
    void* get_Timeline_0__Direction_AF4CEC274DB8CAA5C1936EB248B873EF();
    ...
    void ExecuteUbergraph_Volter_KK_Wave_4_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
