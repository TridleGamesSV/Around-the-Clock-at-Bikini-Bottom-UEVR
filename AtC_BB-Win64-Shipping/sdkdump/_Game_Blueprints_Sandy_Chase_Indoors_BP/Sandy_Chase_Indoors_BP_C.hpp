...
namespace _Game_Blueprints_Sandy_Chase_Indoors_BP {
#pragma pack(push, 1)
struct Sandy_Chase_Indoors_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_710B6B244A113C14BC025B9989E0889E();
    void* get_Timeline_1__Direction_710B6B244A113C14BC025B9989E0889E();
    ...
    void ExecuteUbergraph_Sandy_Chase_Indoors_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
