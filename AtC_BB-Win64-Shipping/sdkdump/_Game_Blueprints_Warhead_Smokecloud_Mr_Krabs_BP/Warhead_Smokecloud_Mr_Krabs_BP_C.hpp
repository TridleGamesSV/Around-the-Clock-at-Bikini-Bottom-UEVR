...
namespace _Game_Blueprints_Warhead_Smokecloud_Mr_Krabs_BP {
#pragma pack(push, 1)
struct Warhead_Smokecloud_Mr_Krabs_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Warhead_Smokecloud_Mr_Krabs_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
