...
_Script_Engine::BodySetup*& _Script_ProceduralMeshComponent::ProceduralMeshComponent::get_ProcMeshBodySetup() {
    return *(_Script_Engine::BodySetup**)((uintptr_t)this + 0x698);
}
...
void _Script_ProceduralMeshComponent::ProceduralMeshComponent::UpdateMeshSection_LinearColor(int32_t SectionIndex, void*& Vertices, void*& Normals, void*& UV0, void*& VertexColors, void*& Tangents) {
    return;
}
...
void _Script_ProceduralMeshComponent::ProceduralMeshComponent::CreateMeshSection_LinearColor(int32_t SectionIndex, void*& Vertices, void*& Triangles, void*& Normals, void*& UV0, void*& VertexColors, void*& Tangents, bool bCreateCollision) {
    return;
}
