...
namespace _Game_Talk_Widgets_MrKrabs_Mid_Goo_Lagoon_7 {
#pragma pack(push, 1)
struct MrKrabs_Mid_Goo_Lagoon_7_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_MrKrabs_Mid_Goo_Lagoon_7(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
