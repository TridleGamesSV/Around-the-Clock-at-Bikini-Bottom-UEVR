...
namespace _Game_Blueprints_Jellien_Pinkie_After_KK_3_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_After_KK_3_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_20212F32483B47E99EFDAD8539996C9C();
    void* get_Timeline_0__Direction_20212F32483B47E99EFDAD8539996C9C();
    _Script_Engine::TimelineComponent*& get_Timeline_0();
    float& get_Timeline_1_Walk_A54A24704DCDDCC74FFEC0A0584A2C0E();
    void* get_Timeline_1__Direction_A54A24704DCDDCC74FFEC0A0584A2C0E();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_After_KK_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
