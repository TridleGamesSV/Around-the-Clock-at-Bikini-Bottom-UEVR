...
_Script_Engine::Texture2D*& _Script_Paper2D::PaperSprite::get_SourceTexture() {
    return *(_Script_Engine::Texture2D**)((uintptr_t)this + 0x48);
}
void* _Script_Paper2D::PaperSprite::get_SourceDimension() {
    return (void*)((uintptr_t)this + 0x40);
}
void* _Script_Paper2D::PaperSprite::get_SourceUV() {
...
_Script_Engine::BodySetup*& _Script_Paper2D::PaperSprite::get_BodySetup() {
    return *(_Script_Engine::BodySetup**)((uintptr_t)this + 0xa0);
}
