...
namespace _Game_Blueprints_Ketamine_Bottle_BP {
#pragma pack(push, 1)
struct Ketamine_Bottle_BP_C : public _Script_Engine::StaticMeshActor {
    void* get_UberGraphFrame();
    _Script_Engine::BoxComponent*& get_Box();
    _Script_Engine::StaticMeshComponent*& get_Text();
    ...
    void ExecuteUbergraph_Ketamine_Bottle_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
