...
namespace _Game_Blueprints_Jellien_Pinkie_KK_3_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_KK_3_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_F300FAB34C3E2C7593EE62A96A4F9C9C();
    void* get_Timeline_1__Direction_F300FAB34C3E2C7593EE62A96A4F9C9C();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_KK_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
