...
namespace _Game_Blueprints_Krusty_Door_Destroyable_BP {
#pragma pack(push, 1)
struct Krusty_Door_Destroyable_BP_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_Krusty_Door_Destroyable_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
