...
namespace _Game_Blueprints_Doodle_Patrick_Boss_Phase_2_End_BP {
#pragma pack(push, 1)
struct Doodle_Patrick_Boss_Phase_2_End_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Doodle_Patrick_Boss_Phase_2_End_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
