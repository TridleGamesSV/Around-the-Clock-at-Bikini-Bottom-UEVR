...
namespace _Game_Blueprints_Mrs_Puff_Look_Around_BP {
#pragma pack(push, 1)
struct Mrs_Puff_Look_Around_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Mrs_Puff_Look_Around_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
