...
namespace _Game_Menus_Surveillance_6_Movement_2 {
#pragma pack(push, 1)
struct Surveillance_6_Movement_2_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Surveillance_6_Movement_2(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
