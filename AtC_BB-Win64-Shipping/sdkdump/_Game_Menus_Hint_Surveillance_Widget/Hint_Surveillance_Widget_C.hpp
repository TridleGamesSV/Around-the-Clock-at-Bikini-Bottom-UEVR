...
namespace _Game_Menus_Hint_Surveillance_Widget {
#pragma pack(push, 1)
struct Hint_Surveillance_Widget_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Hint_Surveillance_Widget(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
