...
namespace _Game_Blueprints_Exit_Treehouse_Flamethrower_BP {
#pragma pack(push, 1)
struct Exit_Treehouse_Flamethrower_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Exit_Treehouse_Flamethrower_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
