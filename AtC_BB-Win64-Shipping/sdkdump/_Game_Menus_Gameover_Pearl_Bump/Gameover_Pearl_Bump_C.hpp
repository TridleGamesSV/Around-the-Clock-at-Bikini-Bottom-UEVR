...
namespace _Game_Menus_Gameover_Pearl_Bump {
#pragma pack(push, 1)
struct Gameover_Pearl_Bump_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Pearl_Bump(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
