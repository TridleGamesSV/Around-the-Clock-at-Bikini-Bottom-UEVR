...
namespace _Game_Menus_Gameover_Hash_Kitchen {
#pragma pack(push, 1)
struct Gameover_Hash_Kitchen_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Hash_Kitchen(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
