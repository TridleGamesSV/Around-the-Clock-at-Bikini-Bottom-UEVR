...
struct Canvas : public _Script_CoreUObject::Object {
    ...
    void K2_DrawBox(_Script_CoreUObject::Vector2D ScreenPosition, _Script_CoreUObject::Vector2D ScreenSize, float Thickness);
