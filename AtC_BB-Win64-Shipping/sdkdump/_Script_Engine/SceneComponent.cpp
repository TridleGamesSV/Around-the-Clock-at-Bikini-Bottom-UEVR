...
_Script_Engine::SceneComponent*& _Script_Engine::SceneComponent::get_AttachParent() {
    return *(_Script_Engine::SceneComponent**)((uintptr_t)this + 0x100);
}
...
bool _Script_Engine::SceneComponent::get_bVisible() {
    return (*(uint8_t*)((uintptr_t)this + 0x1bc + 0)) & 16 != 0;
}
...
bool _Script_Engine::SceneComponent::get_bAbsoluteScale() {
    return (*(uint8_t*)((uintptr_t)this + 0x1bc + 0)) & 8 != 0;
}
void _Script_Engine::SceneComponent::set_bAbsoluteScale(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x1bc + 0);
    *(uint8_t*)((uintptr_t)this + 0x1bc + 0) = (cur_value & ~8) | (value ? 8 : 0);
}
