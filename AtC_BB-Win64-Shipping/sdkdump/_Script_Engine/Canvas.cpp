...
void _Script_Engine::Canvas::K2_DrawBox(_Script_CoreUObject::Vector2D ScreenPosition, _Script_CoreUObject::Vector2D ScreenSize, float Thickness) {
    return;
}
