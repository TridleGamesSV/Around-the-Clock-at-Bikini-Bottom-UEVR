...
bool _Script_Engine::CameraComponent::get_bUseControllerViewRotation() {
    return (*(uint8_t*)((uintptr_t)this + 0x828 + 0)) & 1 != 0;
}
void _Script_Engine::CameraComponent::set_bUseControllerViewRotation(bool value) {
