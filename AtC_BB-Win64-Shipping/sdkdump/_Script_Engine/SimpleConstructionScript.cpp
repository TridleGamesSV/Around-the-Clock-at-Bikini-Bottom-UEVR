...
_Script_Engine::SCS_Node*& _Script_Engine::SimpleConstructionScript::get_RootNode() {
    return *(_Script_Engine::SCS_Node**)((uintptr_t)this + 0x50);
}
...
void* _Script_Engine::SimpleConstructionScript::get_ActorComponentNodes() {
