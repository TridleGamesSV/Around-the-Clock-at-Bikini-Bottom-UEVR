...
_Script_Engine::AsyncActionLoadPrimaryAsset* _Script_Engine::AsyncActionLoadPrimaryAsset::AsyncLoadPrimaryAsset(_Script_CoreUObject::PrimaryAssetId PrimaryAsset, void*& LoadBundles) {
    return;
}
