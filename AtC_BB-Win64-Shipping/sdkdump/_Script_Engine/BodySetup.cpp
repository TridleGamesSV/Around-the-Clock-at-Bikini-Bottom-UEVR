...
void _Script_Engine::BodySetup::set_bGenerateMirroredCollision(bool value) {
    ...
    *(uint8_t*)((uintptr_t)this + 0x79 + 0) = (cur_value & ~64) | (value ? 64 : 0);
}
...
void _Script_Engine::BodySetup::set_bConsiderForBounds(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x79 + 0);
    *(uint8_t*)((uintptr_t)this + 0x79 + 0) = (cur_value & ~2) | (value ? 2 : 0);
}
...
_Script_Engine::PhysicalMaterial*& _Script_Engine::BodySetup::get_PhysMaterial() {
    return *(_Script_Engine::PhysicalMaterial**)((uintptr_t)this + 0x80);
}
