...
namespace _Game_Menus_Gameover_Hash_Window {
#pragma pack(push, 1)
struct Gameover_Hash_Window_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Hash_Window(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
