...
namespace _Game_Menus_Overlord_Health_4 {
#pragma pack(push, 1)
struct Overlord_Health_4_C : public _Script_UMG::UserWidget {
    ...
    void Construct0();
    void ExecuteUbergraph_Overlord_Health_4(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
