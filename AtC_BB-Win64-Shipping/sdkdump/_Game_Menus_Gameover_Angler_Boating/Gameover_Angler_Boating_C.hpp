...
namespace _Game_Menus_Gameover_Angler_Boating {
#pragma pack(push, 1)
struct Gameover_Angler_Boating_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Angler_Boating(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
