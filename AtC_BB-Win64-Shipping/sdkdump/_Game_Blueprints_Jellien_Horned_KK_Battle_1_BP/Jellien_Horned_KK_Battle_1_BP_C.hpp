...
namespace _Game_Blueprints_Jellien_Horned_KK_Battle_1_BP {
#pragma pack(push, 1)
struct Jellien_Horned_KK_Battle_1_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_263C933C4C11FBFCE0AC78BDA76543BD();
    void* get_Timeline_1__Direction_263C933C4C11FBFCE0AC78BDA76543BD();
    ...
    void OnFail_B7F4FD754597F0A87C122280195CEC9F(void* MovementResult);
    void OnSuccess_B7F4FD754597F0A87C122280195CEC9F(void* MovementResult);
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ReceiveBeginPlay();
    void ExecuteUbergraph_Jellien_Horned_KK_Battle_1_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
