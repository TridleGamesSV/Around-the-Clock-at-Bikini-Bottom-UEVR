...
namespace _Game_Menus_Gameover_Doodle_Bob {
#pragma pack(push, 1)
struct Gameover_Doodle_Bob_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Doodle_Bob(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
