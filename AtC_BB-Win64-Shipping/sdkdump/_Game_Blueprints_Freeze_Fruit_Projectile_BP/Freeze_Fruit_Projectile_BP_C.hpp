...
namespace _Game_Blueprints_Freeze_Fruit_Projectile_BP {
#pragma pack(push, 1)
struct Freeze_Fruit_Projectile_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Freeze_Fruit_Projectile_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
