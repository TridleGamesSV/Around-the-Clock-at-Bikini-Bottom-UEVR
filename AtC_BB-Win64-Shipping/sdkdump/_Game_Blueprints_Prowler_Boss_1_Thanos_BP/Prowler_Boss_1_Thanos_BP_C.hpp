...
namespace _Game_Blueprints_Prowler_Boss_1_Thanos_BP {
#pragma pack(push, 1)
struct Prowler_Boss_1_Thanos_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Prowler_Boss_1_Thanos_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
