...
namespace _Game_Menus_Guitar_Cooldown_Bar {
#pragma pack(push, 1)
struct Guitar_Cooldown_Bar_C : public _Script_UMG::UserWidget {
    ...
    float GetPercent_0();
    void Construct0();
    void ExecuteUbergraph_Guitar_Cooldown_Bar(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
