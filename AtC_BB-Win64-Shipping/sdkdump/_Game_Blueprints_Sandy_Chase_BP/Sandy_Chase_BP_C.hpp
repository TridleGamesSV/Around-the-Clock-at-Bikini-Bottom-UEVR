...
namespace _Game_Blueprints_Sandy_Chase_BP {
#pragma pack(push, 1)
struct Sandy_Chase_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_FD1E7F37403D5DC3A36F30BC146977FB();
    void* get_Timeline_1__Direction_FD1E7F37403D5DC3A36F30BC146977FB();
    ...
    void ExecuteUbergraph_Sandy_Chase_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
