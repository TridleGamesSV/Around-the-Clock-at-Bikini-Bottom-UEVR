...
namespace _Game_Blueprints_Jellien_Prowler_KK_BP {
#pragma pack(push, 1)
struct Jellien_Prowler_KK_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_77373A0A46C79923C1B413BB412594A1();
    void* get_Timeline_1__Direction_77373A0A46C79923C1B413BB412594A1();
    ...
    void ExecuteUbergraph_Jellien_Prowler_KK_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
