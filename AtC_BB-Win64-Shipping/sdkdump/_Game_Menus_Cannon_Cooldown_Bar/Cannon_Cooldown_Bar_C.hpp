...
namespace _Game_Menus_Cannon_Cooldown_Bar {
#pragma pack(push, 1)
struct Cannon_Cooldown_Bar_C : public _Script_UMG::UserWidget {
    ...
    float GetPercent_0();
    void Construct0();
    void ExecuteUbergraph_Cannon_Cooldown_Bar(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
