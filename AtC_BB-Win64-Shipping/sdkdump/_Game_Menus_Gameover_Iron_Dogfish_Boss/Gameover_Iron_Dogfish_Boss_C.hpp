...
namespace _Game_Menus_Gameover_Iron_Dogfish_Boss {
#pragma pack(push, 1)
struct Gameover_Iron_Dogfish_Boss_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Iron_Dogfish_Boss(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
