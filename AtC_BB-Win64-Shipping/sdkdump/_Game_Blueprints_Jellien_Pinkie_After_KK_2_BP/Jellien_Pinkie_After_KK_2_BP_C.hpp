...
namespace _Game_Blueprints_Jellien_Pinkie_After_KK_2_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_After_KK_2_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_1698B55B48CDAFED294989B5D636963E();
    void* get_Timeline_0__Direction_1698B55B48CDAFED294989B5D636963E();
    _Script_Engine::TimelineComponent*& get_Timeline_0();
    float& get_Timeline_1_Walk_B8E156794844051025E7CA8F57CDE4E3();
    void* get_Timeline_1__Direction_B8E156794844051025E7CA8F57CDE4E3();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_After_KK_2_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
