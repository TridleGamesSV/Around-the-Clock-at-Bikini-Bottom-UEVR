...
namespace _Game_Blueprints_Squid_Guard_Surv_1_BP {
#pragma pack(push, 1)
struct Squid_Guard_Surv_1_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Squid_Guard_Surv_1_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
