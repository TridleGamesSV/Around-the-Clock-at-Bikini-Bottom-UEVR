...
namespace _Game_Menus_Hint_Mermalair_Boss_New_Widget_2 {
#pragma pack(push, 1)
struct Hint_Mermalair_Boss_New_Widget_2_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Hint_Mermalair_Boss_New_Widget_2(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
