...
namespace _Game_Menus_Bubbles_Black_Background {
#pragma pack(push, 1)
struct Bubbles_Black_Background_C : public _Script_UMG::UserWidget {
    ...
    void Construct0();
    void ExecuteUbergraph_Bubbles_Black_Background(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
