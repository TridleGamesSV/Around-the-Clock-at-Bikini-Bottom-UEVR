...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_C648F68841066DB8E349FDB55C5D5C2A(void* MovementResult);
    void OnSuccess_C648F68841066DB8E349FDB55C5D5C2A(void* MovementResult);
    void OnFail_3B40B1994F4A88FF448E0385BBDBFCF3(void* MovementResult);
    void OnSuccess_3B40B1994F4A88FF448E0385BBDBFCF3(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
