...
namespace _Game_Menus_Surveillance_8_Movement {
#pragma pack(push, 1)
struct Surveillance_8_Movement_C : public _Script_UMG::UserWidget {
    ...
    void BndEvt__Button_0_K2Node_ComponentBoundEvent_31_OnButtonPressedEvent__DelegateSignature();
    void ExecuteUbergraph_Surveillance_8_Movement(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
