...
namespace _Game_Blueprints_Pearl_Awake_BP {
#pragma pack(push, 1)
struct Pearl_Awake_BP_C : public _Script_Engine::Character {
    void* get_UberGraphFrame();
    _Script_Engine::AudioComponent*& get_Chase();
    _Script_Engine::AudioComponent*& get_Sigh();
    ...
    void OnFail_5C69C95D4CADF79049547492936CE3BB(void* MovementResult);
    void OnSuccess_5C69C95D4CADF79049547492936CE3BB(void* MovementResult);
    ...
    void ExecuteUbergraph_Pearl_Awake_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
