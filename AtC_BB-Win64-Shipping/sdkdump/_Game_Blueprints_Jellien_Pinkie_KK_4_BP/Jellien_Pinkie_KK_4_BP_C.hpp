...
namespace _Game_Blueprints_Jellien_Pinkie_KK_4_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_KK_4_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_06A4B7B24935E6C8E40704900F9D46FF();
    void* get_Timeline_1__Direction_06A4B7B24935E6C8E40704900F9D46FF();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_KK_4_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
