...
namespace _Game_Menus_Gameover_MrKrabs_Die_Final_KK {
#pragma pack(push, 1)
struct Gameover_MrKrabs_Die_Final_KK_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_MrKrabs_Die_Final_KK(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
