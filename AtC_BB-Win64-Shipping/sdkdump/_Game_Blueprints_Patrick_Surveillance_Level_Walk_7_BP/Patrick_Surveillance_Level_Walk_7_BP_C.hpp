...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_7_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_7_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_9B2B9CD14EDEDF4AC3C0FEB9C1DE6590(void* MovementResult);
    void OnSuccess_9B2B9CD14EDEDF4AC3C0FEB9C1DE6590(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_7_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
