...
namespace _Game_Menus_Gameover_Larry_The_Lobster_End {
#pragma pack(push, 1)
struct Gameover_Larry_The_Lobster_End_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Larry_The_Lobster_End(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
