...
namespace _Game_Blueprints_Squid_Guard_Surv_1_Chase_BP {
#pragma pack(push, 1)
struct Squid_Guard_Surv_1_Chase_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_0_Walk_73CAAD8C437FFD01626901B5D33B6517();
    void* get_Timeline_0__Direction_73CAAD8C437FFD01626901B5D33B6517();
    ...
    void ExecuteUbergraph_Squid_Guard_Surv_1_Chase_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
