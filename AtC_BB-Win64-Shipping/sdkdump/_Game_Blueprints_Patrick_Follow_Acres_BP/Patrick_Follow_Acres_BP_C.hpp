...
namespace _Game_Blueprints_Patrick_Follow_Acres_BP {
#pragma pack(push, 1)
struct Patrick_Follow_Acres_BP_C : public _Script_Engine::Character {
    void* get_UberGraphFrame();
    _Script_Engine::BoxComponent*& get_Laser_Box();
    ...
    void BndEvt__Laser_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Follow_Acres_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
