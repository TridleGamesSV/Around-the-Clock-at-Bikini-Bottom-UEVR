...
namespace _Game_Blueprints_Jumbo_Shrimp_Thanos_BP {
#pragma pack(push, 1)
struct Jumbo_Shrimp_Thanos_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Jumbo_Shrimp_Thanos_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
