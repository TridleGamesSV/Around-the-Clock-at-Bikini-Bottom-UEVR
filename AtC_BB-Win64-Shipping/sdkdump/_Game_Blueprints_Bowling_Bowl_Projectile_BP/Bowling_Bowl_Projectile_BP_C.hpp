...
namespace _Game_Blueprints_Bowling_Bowl_Projectile_BP {
#pragma pack(push, 1)
struct Bowling_Bowl_Projectile_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Bowling_Bowl_Projectile_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
