...
namespace _Game_Blueprints_Sandy_Sleeping_Indoors_BP {
#pragma pack(push, 1)
struct Sandy_Sleeping_Indoors_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Sandy_Sleeping_Indoors_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
