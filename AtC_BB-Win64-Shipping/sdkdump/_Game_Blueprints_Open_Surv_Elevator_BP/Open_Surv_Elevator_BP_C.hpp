...
namespace _Game_Blueprints_Open_Surv_Elevator_BP {
#pragma pack(push, 1)
struct Open_Surv_Elevator_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Open_Surv_Elevator_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
