...
namespace _Game_Blueprints_Sinister_Slug_3_BP {
#pragma pack(push, 1)
struct Sinister_Slug_3_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Sinister_Slug_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
