...
namespace _Game_Blueprints_Jelly_Projectile_BP {
#pragma pack(push, 1)
struct Jelly_Projectile_BP_C : public _Script_Engine::Actor {
    void* get_UberGraphFrame();
    _Script_Engine::StaticMeshComponent*& get_Jelly_Ball();
    ...
    void ExecuteUbergraph_Jelly_Projectile_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
