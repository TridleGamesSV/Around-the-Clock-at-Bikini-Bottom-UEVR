...
namespace _Game_Blueprints_Jellien_Squirter_KK_2_BP {
#pragma pack(push, 1)
struct Jellien_Squirter_KK_2_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_170B011742F198021DB360ACEEE7C8E0();
    void* get_Timeline_1__Direction_170B011742F198021DB360ACEEE7C8E0();
    ...
    void ExecuteUbergraph_Jellien_Squirter_KK_2_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
