...
namespace _Game_Menus_Gameover_Sandy_Checkpoint {
#pragma pack(push, 1)
struct Gameover_Sandy_Checkpoint_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Sandy_Checkpoint(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
