...
namespace _Game_Blueprints_FrontDoor_Open_BP {
#pragma pack(push, 1)
struct FrontDoor_Open_BP_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_FrontDoor_Open_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
