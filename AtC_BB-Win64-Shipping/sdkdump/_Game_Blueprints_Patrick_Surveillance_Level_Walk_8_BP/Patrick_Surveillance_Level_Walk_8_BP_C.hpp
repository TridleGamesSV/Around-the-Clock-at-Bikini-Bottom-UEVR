...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_8_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_8_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_854B14DF4C4ACD3A129AC8BE65ECEA43(void* MovementResult);
    void OnSuccess_854B14DF4C4ACD3A129AC8BE65ECEA43(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_8_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
