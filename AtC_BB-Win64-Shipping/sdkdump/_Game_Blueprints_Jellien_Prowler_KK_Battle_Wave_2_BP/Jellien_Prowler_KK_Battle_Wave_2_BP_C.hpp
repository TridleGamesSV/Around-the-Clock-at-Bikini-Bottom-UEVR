...
namespace _Game_Blueprints_Jellien_Prowler_KK_Battle_Wave_2_BP {
#pragma pack(push, 1)
struct Jellien_Prowler_KK_Battle_Wave_2_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_132D97C7439A092574D3B49CB2DD7002();
    void* get_Timeline_1__Direction_132D97C7439A092574D3B49CB2DD7002();
    ...
    void ExecuteUbergraph_Jellien_Prowler_KK_Battle_Wave_2_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
