...
namespace _Game_Menus_Hint_Combat_Tutorial_Widget_3 {
#pragma pack(push, 1)
struct Hint_Combat_Tutorial_Widget_3_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Hint_Combat_Tutorial_Widget_3(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
