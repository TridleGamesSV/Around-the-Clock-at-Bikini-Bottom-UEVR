...
namespace _Game_Menus_Gameover_Hash_Front_Door {
#pragma pack(push, 1)
struct Gameover_Hash_Front_Door_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Gameover_Hash_Front_Door(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
