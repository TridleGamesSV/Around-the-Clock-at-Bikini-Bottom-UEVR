...
namespace _Game_Blueprints_Goofy_Employee_Start_BP {
#pragma pack(push, 1)
struct Goofy_Employee_Start_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Goofy_Employee_Start_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
