...
namespace _Game_Blueprints_Freeze_Actor_BP {
#pragma pack(push, 1)
struct Freeze_Actor_BP_C : public _Script_Engine::Actor {
    void* get_UberGraphFrame();
    _Script_Engine::BoxComponent*& get_Box();
    _Script_Engine::SceneComponent*& get_DefaultSceneRoot();
    int32_t& get_Spam_Health();
    ...
    void ExecuteUbergraph_Freeze_Actor_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
