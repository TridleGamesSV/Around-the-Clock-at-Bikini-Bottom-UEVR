...
namespace _Game_Blueprints_Volter_Projectile_3_BP {
#pragma pack(push, 1)
struct Volter_Projectile_3_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Volter_Projectile_3_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
