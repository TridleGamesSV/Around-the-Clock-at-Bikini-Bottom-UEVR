...
namespace _Game_Blueprints_Patrick_Surveillance_Level_Walk_11_BP {
#pragma pack(push, 1)
struct Patrick_Surveillance_Level_Walk_11_BP_C : public _Script_Engine::Character {
    ...
    void OnFail_1698CE484139BBAE2571D284AF3117E6(void* MovementResult);
    void OnSuccess_1698CE484139BBAE2571D284AF3117E6(void* MovementResult);
    void OnFail_B09C967D4789541B86C83593F3B40561(void* MovementResult);
    void OnSuccess_B09C967D4789541B86C83593F3B40561(void* MovementResult);
    void ReceiveBeginPlay();
    void BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Patrick_Surveillance_Level_Walk_11_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
