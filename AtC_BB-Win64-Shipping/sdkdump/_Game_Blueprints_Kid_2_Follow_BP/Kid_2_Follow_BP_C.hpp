...
namespace _Game_Blueprints_Kid_2_Follow_BP {
#pragma pack(push, 1)
struct Kid_2_Follow_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Kid_2_Follow_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
