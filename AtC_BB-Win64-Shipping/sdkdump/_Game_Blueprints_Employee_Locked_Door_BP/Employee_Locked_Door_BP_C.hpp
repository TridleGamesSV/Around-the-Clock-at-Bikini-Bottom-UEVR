...
namespace _Game_Blueprints_Employee_Locked_Door_BP {
#pragma pack(push, 1)
struct Employee_Locked_Door_BP_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_Employee_Locked_Door_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
