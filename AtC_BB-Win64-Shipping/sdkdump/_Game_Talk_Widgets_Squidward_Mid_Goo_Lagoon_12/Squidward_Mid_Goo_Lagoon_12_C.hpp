...
namespace _Game_Talk_Widgets_Squidward_Mid_Goo_Lagoon_12 {
#pragma pack(push, 1)
struct Squidward_Mid_Goo_Lagoon_12_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Squidward_Mid_Goo_Lagoon_12(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
