...
namespace _Game_Talk_Widgets_Employee_Broom_Closet_Talk_2 {
#pragma pack(push, 1)
struct Employee_Broom_Closet_Talk_2_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Employee_Broom_Closet_Talk_2(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
