...
namespace _Game_Blueprints_Jellien_Pinkie_KK_OM_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_KK_OM_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_3D6C0DDD48634A227DD35997267CDB53();
    void* get_Timeline_1__Direction_3D6C0DDD48634A227DD35997267CDB53();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_KK_OM_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
