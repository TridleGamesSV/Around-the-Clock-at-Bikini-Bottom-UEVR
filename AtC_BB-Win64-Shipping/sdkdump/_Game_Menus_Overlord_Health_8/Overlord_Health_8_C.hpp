...
namespace _Game_Menus_Overlord_Health_8 {
#pragma pack(push, 1)
struct Overlord_Health_8_C : public _Script_UMG::UserWidget {
    ...
    void Construct0();
    void ExecuteUbergraph_Overlord_Health_8(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
