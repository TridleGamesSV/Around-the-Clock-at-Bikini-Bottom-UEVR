...
namespace _Game_Blueprints_Wormy_BP {
#pragma pack(push, 1)
struct Wormy_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_4D3AC16E4994CA3995FDFDBB110B0F8C();
    void* get_Timeline_1__Direction_4D3AC16E4994CA3995FDFDBB110B0F8C();
    ...
    void ExecuteUbergraph_Wormy_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
