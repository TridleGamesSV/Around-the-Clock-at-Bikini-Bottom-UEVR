...
namespace _Game_Blueprints_Jellien_Pinkie_KK_BP {
#pragma pack(push, 1)
struct Jellien_Pinkie_KK_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_8482E6714761B998B7B3D98B90ED4AD4();
    void* get_Timeline_1__Direction_8482E6714761B998B7B3D98B90ED4AD4();
    ...
    void ExecuteUbergraph_Jellien_Pinkie_KK_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
