...
namespace _Game_Blueprints_Anchor_Dumbell_Heavy_BP {
#pragma pack(push, 1)
struct Anchor_Dumbell_Heavy_BP_C : public _Script_Engine::Actor {
    ...
    void ExecuteUbergraph_Anchor_Dumbell_Heavy_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
