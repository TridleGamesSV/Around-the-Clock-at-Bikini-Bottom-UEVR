...
namespace _Game_Blueprints_Bathroom_Door_Pearl_BP {
#pragma pack(push, 1)
struct Bathroom_Door_Pearl_BP_C : public _Script_Engine::StaticMeshActor {
    ...
    void ExecuteUbergraph_Bathroom_Door_Pearl_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
