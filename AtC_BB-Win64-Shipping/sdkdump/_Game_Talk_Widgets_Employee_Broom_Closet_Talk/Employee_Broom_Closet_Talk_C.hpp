...
namespace _Game_Talk_Widgets_Employee_Broom_Closet_Talk {
#pragma pack(push, 1)
struct Employee_Broom_Closet_Talk_C : public _Script_UMG::UserWidget {
    ...
    void ExecuteUbergraph_Employee_Broom_Closet_Talk(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
