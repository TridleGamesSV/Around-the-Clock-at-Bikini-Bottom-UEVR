...
namespace _Game_Blueprints_Warhead_Jellien_BP {
#pragma pack(push, 1)
struct Warhead_Jellien_BP_C : public _Script_Engine::Character {
    ...
    void ExecuteUbergraph_Warhead_Jellien_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
