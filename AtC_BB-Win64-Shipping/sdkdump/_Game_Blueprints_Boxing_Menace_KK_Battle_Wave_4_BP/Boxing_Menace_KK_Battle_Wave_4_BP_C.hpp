...
namespace _Game_Blueprints_Boxing_Menace_KK_Battle_Wave_4_BP {
#pragma pack(push, 1)
struct Boxing_Menace_KK_Battle_Wave_4_BP_C : public _Script_Engine::Character {
    ...
    float& get_Timeline_1_Walk_6ACA1B7248B67C027F02C9A11DAB353A();
    void* get_Timeline_1__Direction_6ACA1B7248B67C027F02C9A11DAB353A();
    ...
    void ExecuteUbergraph_Boxing_Menace_KK_Battle_Wave_4_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
