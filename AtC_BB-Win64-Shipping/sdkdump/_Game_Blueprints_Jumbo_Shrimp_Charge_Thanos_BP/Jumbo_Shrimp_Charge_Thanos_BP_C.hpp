...
namespace _Game_Blueprints_Jumbo_Shrimp_Charge_Thanos_BP {
#pragma pack(push, 1)
struct Jumbo_Shrimp_Charge_Thanos_BP_C : public _Script_Engine::Character {
    void* get_UberGraphFrame();
    _Script_Engine::StaticMeshComponent*& get_Circle();
    _Script_Engine::BoxComponent*& get_Range_Box();
    ...
    void BndEvt__Range_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(_Script_Engine::PrimitiveComponent* OverlappedComponent, _Script_Engine::Actor* OtherActor, _Script_Engine::PrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, _Script_Engine::HitResult& SweepResult);
    void ExecuteUbergraph_Jumbo_Shrimp_Charge_Thanos_BP(int32_t EntryPoint);
}; // Size: 0x28
#pragma pack(pop)
}
